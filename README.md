...
Note: We need to modify the working director 5 times because we place the data from each year in a separate folder/directory. Therefore, if you put all the data files in a single directory, you can modify the code to set the working directory only once. 
